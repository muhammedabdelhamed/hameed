        ...
        <div className=" mx-auto pt-16 -pb-10 max-w-7xl">
          <div className=" mx-auto flex flex-col ">
            ...
            <div className="mx-auto transition-all duration-1000 ease-in-out -mt-8">
              <Image
                ...
                height={800}
                width={800}
                className="select-none h-80 w-80"
                alt="Muhammed abdelhamed"
                priority
              />
            </div>
          ...
          <div className=" text-[0.92rem] text-base mx-8 font-light dark:text-white text-gray-900">
            ...
            <p className="">
              ...
              <a
                onClick={() =>
                  navigator.clipboard.writeText("muhammedabdelhamidmuhammed@gmail.com")
                }
                ...
                href="mailto:muhammedabdelhamidmuhammed@gmail.com"
              >
                {" "}
              ...
              <a
                href="https://www.instagram.com/thisizhamid"
                target="blank"
                rel="noopener noreferrer"
